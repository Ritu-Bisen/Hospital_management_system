            ...
            <div className="bg-white w-full max-w-7xl rounded-xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                ...
                <div className="p-3 md:p-4 border-b border-gray-200 flex justify-between items-center bg-gradient-to-r from-blue-50 to-blue-100">
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        <div>
                            <h2 className="text-lg md:text-xl font-bold text-gray-800">RMO Task Details for {nurseName}</h2>
                            <p className="hidden md:block text-sm text-gray-600">Complete RMO task history and performance</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                        ...
                        <>
                            ...
                            <div className="bg-white p-3 md:p-4 rounded-lg border border-gray-200">
                                <div className="flex justify-between items-center mb-2 md:mb-0">
                                    <h3 className="text-sm md:text-lg font-bold text-gray-800">Filters</h3>
                                    <div className="text-[10px] md:text-sm text-gray-600">
                                        {filteredTasks.length} / {rmoTasks.length}
                                    </div>
                                </div>
