            ...
            <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col p-4 md:p-6 overflow-hidden space-y-4 md:space-y-6">
                ...
                <div className="flex flex-row justify-between items-center gap-4 shrink-0">
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-500 text-sm mt-1 hidden md:block">Real-time performance metrics based on task completion</p>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 shrink-0">
                    ...
                    <div className="bg-white p-3 md:p-6 rounded-xl shadow-sm border border-gray-200">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[10px] md:text-sm font-medium text-gray-500 uppercase md:normal-case">Active Staff</p>
                                <h3 className="text-lg md:text-2xl font-bold text-gray-900 mt-1 md:mt-2">{summary.uniqueNurses}</h3>
                            </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-6 shrink-0">
                    ...
                    <div className="bg-white p-3 md:p-6 rounded-xl shadow-sm border border-gray-200">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[10px] md:text-sm font-medium text-gray-500 uppercase md:normal-case">Top Staff</p>
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 flex-1 flex flex-col min-h-0 overflow-hidden mb-2">
                    <div className="p-4 md:p-6 border-b border-gray-200 bg-gray-50 flex justify-between items-center shrink-0">
                        <h2 className="text-base md:text-lg font-bold text-gray-800">Staff Rankings</h2>
                        <button
                                    ...
                                    nurseStats.map((stat, index) => (
                                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <button onClick={() => handleViewNurseTasks(stat.name)} className="text-blue-600 hover:text-blue-800 font-medium text-sm">View</button>
                                            </td>
                                        </tr>
                                    ))
                                )}
                    ...
                    <div className="md:hidden overflow-y-auto flex-1 scroll-container divide-y divide-gray-100 bg-gray-50">
                        {nurseStats.length === 0 ? (
                            <div className="p-8 text-center text-gray-500 text-sm bg-white">No nurse data available.</div>
                        ) : (
                            nurseStats.map((stat, index) => (
